...
public class IntrospectedTableMyBatis3Impl extends IntrospectedTable {
    ...
    //add by yehongyu(set javaExampleGenerators)
    ...
    protected void calculateJavaModelGenerators(List<String> warnings,
            ProgressCallback progressCallback) {
        //commented by yehongyu(set javaExampleGenerators in other)
//        if (getRules().generateExampleClass()) {
//            AbstractJavaGenerator javaGenerator = new ExampleGenerator();
//            initializeAbstractGenerator(javaGenerator, warnings,
//                    progressCallback);
...
//        }
    ...
    public List<GeneratedJavaFile> getGeneratedJavaFiles() {
        ...
        //add by yehongyu(set javaExampleGenerators targetProject)
    ...
    public int getGenerationSteps() {
        //modify by yehongyu(add javaExampleGenerators.size())
