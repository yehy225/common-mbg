...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_INSERT_BATCH_STATEMENT_ID, //add by yehongyu(add insertBatch)
    ...
    public void initialize() {
        ...
        //add by yehongyu(set example package)
    ...
    protected void calculateXmlAttributes() {
        ...
        //add by yehongyu(add insertBatch)
    ...
    protected void calculateModelAttributes() {
        ...
        //commented by yehongyu(set example package in other)
//        sb.setLength(0);
//        sb.append(pakkage);
//        sb.append('.');
//        sb.append(fullyQualifiedTable.getDomainObjectName());
...
//        setExampleType(sb.toString());
    ...
    public void setBaseRecordType(String baseRecordType) {
        internalAttributes.put(InternalAttribute.ATTR_BASE_RECORD_TYPE,
                baseRecordType);
        /** start ----- modified by yehongyu (add Mo) */
        internalAttributes.put(InternalAttribute.ATTR_BASE_RECORD_TYPE,
                baseRecordType + "Mo");
        /** end ----- modified by yehongyu (add Mo) */
    }
